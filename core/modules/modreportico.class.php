 ...
 *  \file       htdocs/mymodule/core/modules/modreportico.class.php
 *  \ingroup    mymodule
 ...
 */
class modreportico extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->picto='reportico@reportico';
		...
		$this->langfiles = array("reportico@reportico");
		...
		// );
		$this->const = array();
                //$this->const[0] = array("TIMESHEET_TIME_TYPE","chaine","hours","layout mode of the reporticos"); // hours or days
